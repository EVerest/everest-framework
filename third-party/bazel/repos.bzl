...
def everest_framework_repos(repo_mapping = {}):
    ...
    maybe(
        ...
        build_file = "@everest-framework//third-party/bazel:BUILD.curl.bazel",
        repo_mapping = repo_mapping,
    )
    ...
    maybe(
        ...
        strip_prefix = "sqlite-amalgamation-3490200",
        build_file = "@everest-framework//third-party/bazel:BUILD.sqlite3.bazel",
        repo_mapping = repo_mapping,
    )
