...
public:
    ...
    void test_empty_config() {
        Everest::Config config = Everest::Config("../dist/schemas", "valid/config.json", "test_modules", "test_interfaces");
    ...
    void test_wrong_maindir() {
        BOOST_CHECK_THROW(Everest::Config("../dist/schemas", "wrong_maindir", "test_modules", "test_interfaces"), Everest::EverestConfigError);
    }
    ...
    void test_missing_config() {
        BOOST_CHECK_THROW(Everest::Config("../dist/schemas", "missing_config", "test_modules", "test_interfaces"), Everest::EverestConfigError);
    }
    ...
    void test_broken_config() {
        BOOST_CHECK_THROW(Everest::Config("../dist/schemas", "broken_config/config.json", "test_modules", "test_interfaces"), Everest::EverestConfigError);
    }
    ...
    void test_config_with_missing_module() {
        BOOST_CHECK_THROW(Everest::Config("../dist/schemas", "missing_module_config/config.json", "test_modules", "test_interfaces"), Everest::EverestConfigError);
    }
    ...
    void test_config_with_broken_manifest() {
        BOOST_CHECK_THROW(Everest::Config("../dist/schemas", "broken_manifest/config.json", "broken_manifest/modules", "test_interfaces"), Everest::EverestConfigError);
        BOOST_CHECK_THROW(Everest::Config("../dist/schemas", "broken_manifest2/config.json", "broken_manifest2/modules", "test_interfaces"), Everest::EverestConfigError);
    }
    ...
    void test_config_with_valid_manifest_missing_class() {
        BOOST_CHECK_THROW(Everest::Config("../dist/schemas", "valid_manifest_missing_interface/config.json", "valid_manifest_missing_interface/modules", "test_interfaces"), Everest::EverestConfigError);
    }
    ...
    void test_config_with_valid_manifest_valid_class() {
        Everest::Config("../dist/schemas", "valid_manifest_valid_interface/config.json", "valid_manifest_valid_interface/modules", "valid_manifest_valid_interface/interfaces");
    }
