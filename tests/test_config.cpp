...
SCENARIO("Check config parser", "[!throws]") {
    GIVEN("An empty config") {
        Config config{std::make_shared<RuntimeSettings>("../../schemas", "valid/config.yaml")};
    ...
    //     THEN("It should throw Everest::EverestConfigError") {
    //         CHECK_THROWS_AS(Everest::Config("../../schemas", "broken_manifest/config.yaml",
    //         "broken_manifest/modules",
    //                                         "test_interfaces", "dummy_types", "", ""),
    //                         Everest::EverestConfigError);
    //         // FIXME: an empty manifest breaks the test?
    //         CHECK_THROWS_AS(Everest::Config("../../schemas", "broken_manifest2/config.yaml",
    //         "broken_manifest2/modules",
    //                                         "test_interfaces", "dummy_types", "", ""),
    //                         Everest::EverestConfigError);
    //     }
    // }
