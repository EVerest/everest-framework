set(SETUP_NAME "valid_module_config_validate")
...
file(COPY test_interfaces/test_interface_cmd_var.yaml DESTINATION ${SETUP_NAME}/interfaces)
file(COPY test_types/test_type.yaml DESTINATION ${SETUP_NAME}/types)
file(COPY test_modules/TESTValidManifestCmdVar DESTINATION ${SETUP_NAME}/modules)
